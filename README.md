<div align="center">
<img src="/docs/maestro-dark-mode.svg#gh-dark-mode-only" width="250" />
<img src="/docs/maestro-dark-mode.svg#gh-light-mode-only" width="250" />
  <h1>Maestro</h1>
...
```sh
npx degit atilafassina/maestro
```
...
```sh
git clone --depth 1 https://github.com/atilafassina/maestro
```
...
With a few opinionated defaults, Maestro enforces a smaller binary size than stock Tauri templates. Except for some special cases, these work particularly well.
